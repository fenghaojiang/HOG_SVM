...
const string NegDir = "E://HOG_SVM//Project1//Project1//INRIAPerson//train_64x128_H96//neg//";
const string SaveDir = "E://HOG_SVM//TestAcc//HardExample//";
...
int main(int argc, char** argv)
{
	...
	string saveName;//找出来的HardExample图片文件名
...
//  namedWindow("people detector", 1);
	...
	while (getline(fin, ImgName))
	{
		...
		for (i = 0; i < found_filtered.size(); i++)
		{
			...
			saveName = "HardExample" + to_string(++HardExampleCount) + ".jpg";
			imwrite(SaveDir + saveName, imgROI);
		}
